<template>
  <div class="container px-5 mb-3 mt-3">
    <div class="row">
      <div class="col">
...
export default {
  ...
  methods: {
    onSubmitM () {
      ...
      axios.post('http://localhost:8080/api/materiels', formData123, { headers: { 'X-Requested-With': 'XMLHttpRequested' } }).then((response) => console.log(response)).catch((error) => console.log(error))
      console.log('++++++++Success++++++++++')
    }
  }
}
