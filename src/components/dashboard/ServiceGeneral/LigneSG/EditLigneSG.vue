          ...
          <div class="card-body mx-5">
            <div class="row">
              ...
              <div class="col-md-6 pl-md-1">
                ...
                <p v-if="$v.ligneSg.date_payement.$error" class="text-danger">Ce champs ne doit pas etre vide</p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 pr-md-1">
                ...
                <p v-if="$v.ligneSg.quantite.$error" class="text-danger">Ce champs doit etre un chiffre</p>
              </div>
              <div class="col-md-6 pl-md-1">
...
export default {
  ...
  created () {
    axios.get('http://localhost:8080/api/ligne_s_gs/' + this.id).then(res => {
      const dataImportedLSG = res.data
      this.ligneSg.num_auto = dataImportedLSG.numAuto
