  ...
  <nav class="navbar navbar-expand-md navbar-light">
    ...
    <div class="collapse navbar-collapse show" id="mynavbar" v-show="collapsed">
      <div class="container-fluid">
        <div class="row ">
          <!--sidebar-->
          <div class=" col-xl-2 col-lg-3 col-md-4 sidebar bg-dark fixed-top">
            ...
            <ul class="navbar-nav flex-column mt-4">
              ...
              <router-link to="/editUser"><li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-user text-light fa-lg mr-3"></i>Profile</a></li></router-link>
          ...
          <!--top-nav-->
          <div class="col-xl-10 col-lg-9  col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar show">
